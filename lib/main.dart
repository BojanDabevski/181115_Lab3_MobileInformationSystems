                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                if (_inputKey.currentState!.validate()) {
                                  name = txt.text;
                                  exams.add(new Exam(name, currentDate, selectedTime));
                                  setState(() {
                                    this.exams = exams;
                                    txt.text = "";
                                    name = "";
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: Column(children: [
                          Container(padding: EdgeInsets.all(5), margin: EdgeInsets.all(5), child: Text(exams[index].name, style: TextStyle(fontWeight: FontWeight.bold))),
